...
from eventos_globales import evento_valvula_izquierda
...
def Threads_valvula_izquierda():
    
    
    
    led_gpio = GPIOControl(pin=6, mode=GPIO.OUT, pull=None)  # Usa el pin GPIO 01(Físicamente es el 29)
    led_gpio.turn_off()
    try:
        while True:
        ...
        print(f"[ERROR] En hilo de válvula izquierda: {e}")
