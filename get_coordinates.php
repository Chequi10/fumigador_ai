...
$sql = "SELECT id, latitud, longitud, rumbo, fecha, velocidad, temperatura, humedad, velocidad_viento, angulo_viento, presion FROM coordenadas WHERE id = (SELECT ID FROM usuarios WHERE nombre = ?)"; // Filtra las coordenadas por el id de usuario
