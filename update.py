...
def update_labels(self, data):
        ...
        if estado >= 80:
            ...
            texto_color = "color: white;"                      # Texto blanco
        elif 60 <= estado < 80:
            rendimiento_color = "background-color: yellow;"    # Aceptable
            texto_color = "color: black;"                      # Texto negro
        elif 40 <= estado < 60:
...
def update_video(self, frame):
    ...
    # ✅ BGR -> QImage: usar RGB888 + rgbSwapped()
    bytes_per_line = ch * new_width
    qimg = QImage(frame_resized.data, new_width, new_height, bytes_per_line, QImage.Format_RGB888).rgbSwapped()
